...
//        render(dataObject);
    ...
    function getFormValue (count){
        ...
        var itemType = form.find("select option:selected").id();
        var itemName = form.find("select option:selected").id();
    ...
    function generateRequest(count){
        ...
        flowInfo.main={};
        return generateRequestMessage(count,defaultLengthPerPage,"operateQuery",flowInfo);
    }
